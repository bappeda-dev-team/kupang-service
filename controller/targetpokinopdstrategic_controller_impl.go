...
// @Router /target-pokin-opd-strategics [post]
...
// @Failure 400 {object} web.WebResponse "Bad Request"
// @Failure 500 {object} web.WebResponse "Internal Server Error"
// @Router /target-pokin-opd-strategics/{id} [put]
...
// @Failure 400 {object} web.WebResponse "Bad Request"
// @Failure 500 {object} web.WebResponse "Internal Server Error"
// @Router /target-pokin-opd-strategics/{id} [delete]
...
// @Success 200 {object} web.WebResponse{data=[]web.TargetPokinOpdStrategicResponse} "OK"
// @Failure 500 {object} web.WebResponse "Internal Server Error"
// @Router /target-pokin-opd-strategics [get]
